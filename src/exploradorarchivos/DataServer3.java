...
public class DataServer3 extends UnicastRemoteObject implements DataServer {

    public DataServer3(File directorio) throws RemoteException {
        super();
    ...
    public static void main(String args[]) {
        try {
            directorio = new File("./Data/DataServer3");
            ...
            reg.rebind("DataServer3", new DataServer1(directorio));
            System.out.println("DataServer3 conectado");
        } catch (Exception e) {
